...
singularity exec --nv /blue/bianjiang/tienyuchang/monaicore1.3.0 python vit_testing.py -e ./config/environment_mednist.json -c ./config/config_infer_vitconv_mednist_80g.json -d -m /blue/bianjiang/tienyuchang/basemodel/checkpoint_test.pth 
