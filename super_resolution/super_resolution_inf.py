...
class SuperResolutionInference():
    ...
    def build_net(self):
        ...
        print_network_params(self.encoder.named_parameters(),show_grad=False)
        print('#'*20)
        print('Build Decoder Network with structure:')
        print_network_params(self.decoder.named_parameters(),show_grad=False)
    ...
    def build_encoder_decoder(self):
        ...
        decoder = Conv_decoder() ###!!! need implement
