...
singularity exec --nv /blue/bianjiang/tienyuchang/monaicore1.3.0 python testing.py -e ./config/environment_mednist.json -c ./config/config_infer_vitconv_mednist_80g.json -d 
