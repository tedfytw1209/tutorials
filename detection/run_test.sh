...
singularity exec --nv /blue/bianjiang/tienyuchang/monaicore1.3.0 python testing.py -e ./config/environment_vit_luna16_fold0.yaml -c ./config/config_infer_vitdet2dimg_luna16_80g.yaml -d
