...
singularity exec --nv /blue/bianjiang/tienyuchang/monaicore1.3.0 python luna16_vit_training.py -e ./config/environment_vit_luna16_fold0.json -c ./config/config_infer_vitdet2dimg_luna16_80g.json -d -m /blue/bianjiang/tienyuchang/basemodel/checkpoint_test.pth 
