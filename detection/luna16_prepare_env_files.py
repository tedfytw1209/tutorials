...
def main():
    #  ------------- Modification starts -------------
    raw_data_base_dir = "/red/bianjiang/tienyu/LUNA16_Images_resample/"  # the directory of the raw images
    resampled_data_base_dir = "/red/bianjiang/tienyu/LUNA16_Images_resample/"  # the directory of the resampled images
